...
def main():
    ...
    runner = Runner(cfg)  # 得到recorder, net, recorder.logger,info ,resume,optimizer,scheduler,evaluator,
                            # wrmup_scheduler,metric
...
# 修改parse_args函数，保留config参数的默认值
def parse_args(gpus=None, load_from=None, config=None):
    parser = argparse.ArgumentParser(description='Train a detector')
    ...
    # 如果提供了config参数，则使用提供的值，否则使用命令行参数的值
